  ...
  describe 'initial state' do
    describe 'white side' do
      it 'has 8 pawns in correct position' do
        ...
        white_pawns_row.each do |position|
          expect(position).to be_instance_of(Pawn)
        end
      end
      ...
      it 'has 2 rooks' do
        ...
        white_rooks.each do |position|
          expect(position).to be_instance_of(Rook)
        end
      end
      ...
      it 'has 2 knights' do
        ...
        white_knights.each do |position|
          expect(position).to be_instance_of(Knight)
        end
      end
      ...
      it 'has 2 bishops' do
        ...
        white_bishops.each do |position|
          expect(position).to be_instance_of(Bishop)
        end
      end
    ...
    describe 'black side' do
      ...
      it 'has 2 rooks' do
        ...
        black_rooks.each do |position|
          expect(position).to be_instance_of(Rook)
        end
      end

      it 'has 2 knights' do
        black_knights = [board.positions[0][1], board.positions[0][6]]

        black_knights.each do |position|
          expect(position).to be_instance_of(Knight)
        end
      end
      ...
      it 'has 2 bishops' do
        ...
        black_bishops.each do |position|
          expect(position).to be_instance_of(Bishop)
        end
      end
